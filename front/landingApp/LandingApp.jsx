...
const LandingApp = React.memo(({landingMode}) => {
    ...
    const priceConfig = {
        ...
        prices: [{
            ...
            product: "Телескопічна щогла AS-4500",
            price: "9500 грн"
        }, {
    ...
    const config = {
        ...
        products: [{
        ...
        },
            {
                ...
                image: '/images/catalog/post-4500.jpg',
                table: {
                    'Транспортні розміри': '1000х200х200мм',
                    'Максимальна робоча висота': '4.5м',
                    'Матеріали секцій': 'Алюміній АД31, Д16Т',
                    'Вага': '6.0кг',
                },
            },
            {
                id: 'as4500',
                label: 'Телескопічна \nщогла Жало 4500',
                image: '/images/catalog/post-4000-sting.jpg',
                table: {
                    'Транспортні розміри': '1300х200х200мм',
                    'Максимальна робоча висота': '4м',
                    'Матеріали секцій': 'Алюміній АД31, СТ30',
                    'Вага': '5.0кг',
                },
            },
        ]
